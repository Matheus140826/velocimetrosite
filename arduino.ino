...
const char* nomeRede = "Gabi_636";
const char* senhaRede = "xawc8090";
const String urlServidor = "http://100.97.232.98/Gabi_636/salvar_dados.php";
...
volatile bool novoPulsoDetectado = false;




float diametroRoda = 0.60f;
float circunferenciaRoda = diametroRoda * 3.141592f;
...
pinMode(PINO_SENSOR_HALL, INPUT_PULLUP);
    circunferenciaRoda = diametroRoda * 3.141592f;
...
float pulsosPorSegundo = 1000000.0f / intervalo;
